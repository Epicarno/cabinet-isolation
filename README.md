...
| 5 | `validate_refs.py` | Проверка | Проверяет что все ссылки `objects/...xml` в XML указывают на реально существующие файлы. Игнорирует ссылки внутри комментариев `//` и `/* */` |
